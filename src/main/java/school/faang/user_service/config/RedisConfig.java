...
import school.faang.user_service.redis.listener.UserBanEventListener;
...
public class RedisConfig {
    ...
    public RedisTemplate<String, Object> eventRedisTemplate(LettuceConnectionFactory lettuceConnectionFactory) {
