...
public class RedisConfig {
    ...
    @Value("${spring.data.redis.channels.start_event_channel}")
    private String startEventChannelName;
    ...
    @Bean
    ChannelTopic topicStartEvent() {
        return new ChannelTopic(startEventChannelName);
    }
}
