...
public class UserController {
    ...
    public ResponseEntity<Resource> getBigImageFromProfile(@PathVariable("user-id") Long userId) {
    ...
    public ResponseEntity<Resource> getSmallImageFromProfile(@PathVariable("user-id") Long userId) {
