...
public class InvitationFilterByInviterId implements GoalInvitationFilter {
    @Override
    ...
    public Stream<GoalInvitation> apply(Stream<GoalInvitation> invitationStream, GoalInvitationFilterDto invitationFilterDto) {
        return invitationStream.filter(invitation -> invitation.getInviter().getId().equals(invitationFilterDto.getInviterId()));
    }
}
