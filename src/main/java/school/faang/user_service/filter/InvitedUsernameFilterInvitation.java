...
@Component
public class InvitedUsernameFilterInvitation implements FilterInvitation<InvitationFilterDto, QGoalInvitation> {
    ...
    public Optional<BooleanExpression> getCondition(InvitationFilterDto filter, QGoalInvitation qGoalInvitation) {
        if (filter.getInvitedNamePattern() != null) {
            return Optional.of(qGoalInvitation.invited.username.like("%" + filter.getInvitedNamePattern() + "%"));
        }
