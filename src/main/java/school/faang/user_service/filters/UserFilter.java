...
public class UserFilter {
    public List<User> filterUsers(Stream<User> userStream, UserFilterDto filter) {
        Predicate<User> namePredicate = user -> filter.getNamePattern() == null || filter.getNamePattern().isBlank() || user.getUsername().equals(filter.getNamePattern());
        Predicate<User> aboutPredicate = user -> filter.getAboutPattern() == null || filter.getAboutPattern().isBlank() || user.getAboutMe().equals(filter.getAboutPattern());
        Predicate<User> emailPredicate = user -> filter.getEmailPattern() == null || filter.getEmailPattern().isBlank() || user.getEmail().equals(filter.getEmailPattern());
        ...
        Predicate<User> countryPredicate = user -> filter.getCountryPattern() == null || filter.getCountryPattern().isBlank() || user.getCountry().getTitle().equals(filter.getCountryPattern());
        Predicate<User> cityPredicate = user -> filter.getCityPattern() == null || filter.getCityPattern().isBlank() || user.getCity().equals(filter.getCityPattern());
        Predicate<User> phonePredicate = user -> filter.getPhonePattern() == null || filter.getPhonePattern().isBlank() || user.getPhone().equals(filter.getPhonePattern());
