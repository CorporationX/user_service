...
public interface RecommendationRequestMapper {
    ...
    @Mapping(source = "skills", target = "skillsId", qualifiedByName = "mapToSkillRequestId")
    ...
    @Named("mapToSkillRequestId")
    static List<Long> mapToSkillRequestId(List<SkillRequest> skillRequests) {
