...
public interface UserRepository extends JpaRepository<User, Long> {
    ...
    @Query("select u from User u where u.username in :usernames or u.email in :emails or u.phone in :phoneNumbers")
    List<User> findExistingUsers(@Param("usernames") Set<String> usernames,
