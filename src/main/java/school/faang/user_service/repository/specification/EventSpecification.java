...
public class EventSpecification {
    ...
    public static Specification<Event> hasDescription(String description) {
        return (root, query, cb) -> description == null || description.isBlank() ? cb.conjunction() :
    ...
    public static Specification<Event> hasMaxAttendees(Integer maxAttendees) {
        return (root, query, cb) -> maxAttendees == null ? cb.conjunction() :
                cb.equal(root.get("maxAttendees"), maxAttendees);
    }
    ...
    public static Specification<Event> hasEventType(EventType eventType) {
        return (root, query, cb) -> eventType == null ? cb.conjunction() :
                cb.equal(root.get("type"), eventType);
    }

    public static Specification<Event> hasEventStatus(EventStatus eventStatus) {
        return (root, query, cb) -> eventStatus == null ? cb.conjunction() :
                cb.equal(root.get("status"), eventStatus);
    }

    public static Specification<Event> hasOwner(Long ownerId) {
        return (root, query, cb) -> ownerId == null ? cb.conjunction() :
