...
public class GoogleConnectionService {
    ...
    public Calendar connectAndGetCalendar() throws GeneralSecurityException, IOException {
    ...
    private static Credential getCredentials(final NetHttpTransport HTTP_TRANSPORT)
            throws IOException {
        // Load client secrets.
        InputStream in = GoogleConnectionService.class.getResourceAsStream(CREDENTIALS_FILE_PATH);
        if (in == null) {
