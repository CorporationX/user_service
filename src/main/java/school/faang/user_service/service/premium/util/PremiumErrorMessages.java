...
public class PremiumErrorMessages {
    public static final String USER_NOT_FOUND_WHEN_BUYING_PREMIUM = "User with id: %s not found, when buying premium";
    public static final String USER_NOT_FOUND_WHEN_BUYING_PROMOTION = "User with id: %s not found, when buying promotion";
