...
public class RecommendationRequestService {
    ...
    public RecommendationRequestDto create(RecommendationRequestDto recommendationRequestDto) {
        ...
        var currentDto = recommendationRequestMapper.toDto(newRequest);

        recommendationRequestedEventPublisher.publish(recommendationRequestMapper.toEvent(currentDto));
