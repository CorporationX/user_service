...
class GoalInvitationInvitedIdFilterTest {
    ...
    private final Long INVITED_ID_NEGATIVE_PATTERN = -1L;
    private final Long INVITED_ID_PATTERN = 1L;
    private final Long INVITED_USER_ID_ONE = 1L;
    private final Long INVITED_USER_ID_TWO = 2L;
