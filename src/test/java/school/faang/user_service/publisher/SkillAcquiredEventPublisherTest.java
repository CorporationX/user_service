...
public class SkillAcquiredEventPublisherTest {
    ...
    @InjectMocks
    private SkillAcquiredEventPublisher eventPublisher;

    private SkillAcquiredEvent testEvent;

    @BeforeEach
    public void setUp() {
        testEvent = new SkillAcquiredEvent(10L, 1L);
    }

    @Test
    @DisplayName("Should publish SkillAcquiredEvent successfully")
