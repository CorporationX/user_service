...
public class RecommendationControllerTest {
    ...
    @Test
    void getAllUserRecommendations_ReturnsListOfRecommendations_WhenCalledWithValidUserId() throws Exception {
    ...
    @Test
    void deleteRecommendation_DeletesEntity_WhenCalled() throws Exception {
