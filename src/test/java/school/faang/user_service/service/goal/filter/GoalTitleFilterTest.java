...
public class GoalTitleFilterTest {
    ...
    @Autowired
    GoalTitleFilter goalTitleFilter;
    ...
    void isApplicable_FilterExist_ReturnsTrue() {
        ...
        boolean actual = goalTitleFilter.isApplicable(filters);
    ...
    void apply_GoalsList_Filtering() {
        ...
        List<Goal> expected = List.of(getGoals().get(2));
        GoalFilterDto filters = GoalFilterDto.builder()
                .titlePattern("it")
                .build();

        goalTitleFilter.apply(actual, filters);
