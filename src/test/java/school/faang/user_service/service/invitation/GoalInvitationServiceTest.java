...
public class GoalInvitationServiceTest {
  ...
  @Mock private GoalInvitationMapper goalInvitationMapper;
  @Mock private GoalRepository goalRepository;
  @InjectMocks private GoalInvitationService goalInvitationService;
  ...
  void testRejectGoalInvitation_InvitationNotFound() {
    ...
    EntityNotFoundException exception =
        assertThrows(
            EntityNotFoundException.class, () -> goalInvitationService.rejectGoalInvitation(1L));
  ...
  void testAcceptGoalInvitation_UserAlreadyHasGoal() {
    ...
    RuntimeException exception =
        assertThrows(RuntimeException.class, () -> goalInvitationService.acceptGoalInvitation(1L));
  ...
  void testAcceptGoalInvitation_InvitationNotFound() {
    ...
    EntityNotFoundException exception =
        assertThrows(
            EntityNotFoundException.class, () -> goalInvitationService.acceptGoalInvitation(1L));
