...
public class MentorshipRequestServiceTestConstants {
    ...
    protected static final MentorshipRequestRequestDto INVALID_MENTORSHIP_REQUEST_REQUEST_DTO
            = new MentorshipRequestRequestDto(INVALID_MENTORSHIP_REQUEST_DESCRIPTION,
    ...
    protected static final MentorshipRequestRequestDto MENTORSHIP_REQUEST_REQUEST_DTO
            = new MentorshipRequestRequestDto(VALID_MENTORSHIP_REQUEST_DESCRIPTION, VALID_USER_ID_1, VALID_USER_ID_2);
    ...
    protected static final MentorshipRequest VALID_MENTORSHIP_REQUEST
            ...
            VALID_REQUEST_STATUS, NULL_REJECTION_REASON, LOCAL_DATE_TIME_NOW, LOCAL_DATE_TIME_NOW);

    protected static final MentorshipRequestResponseDto VALID_MENTORSHIP_REQUEST_RESPONSE_DTO
            = new MentorshipRequestResponseDto(VALID_MENTORSHIP_REQUEST_ID, VALID_MENTORSHIP_REQUEST_DESCRIPTION,
            VALID_USER_ID_1, VALID_USER_ID_2, VALID_REQUEST_STATUS, NULL_REJECTION_REASON, LOCAL_DATE_TIME_NOW,
            LOCAL_DATE_TIME_NOW);
    ...
    protected static final List<MentorshipRequest> VALID_MENTORSHIP_REQUESTS = List.of(VALID_MENTORSHIP_REQUEST);
    ...
    protected static final List<MentorshipRequestFilter> MENTORSHIP_REQUEST_FILTERS
            ...
            REQUESTER_MENTORSHIP_REQUEST_FILTER, STATUS_MENTORSHIP_REQUEST_FILTER);
}
