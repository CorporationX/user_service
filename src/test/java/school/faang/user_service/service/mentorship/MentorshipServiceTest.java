...
class MentorshipServiceTest {
    ...
    private final int SIZE_OF_MENTORS_IS_ONE = 1;
    private final int SIZE_OF_MENTORS_IS_EMPTY = 0;

    private final long USER_ID_IS_ONE = 1L;
    private final long USER_ID_IS_TWO = 2L;
    private final long USER_ID_IS_THREE = 3L;

    @Nested
    class PositiveTests {

        @Nested
        class RemoveUserFromListHisMenteesMethod {
            @Test
