...
import school.faang.user_service.service.filter.goal.InvitationInvitedIdFilter;
...
public class InvitationInvitedIdFilterTest {
    @InjectMocks
    private InvitationInvitedIdFilter invitedIdFilter;
    ...
    void testApplySuccess() {
        ...
        Stream<GoalInvitation> result = invitedIdFilter.apply(invitations, filterDto);
