...
public class MentorshipRequestServiceTest {
    ...
    private MentorshipRequestDto setUp(MentorshipRequestDto mentorshipRequestDto) {
        List<Long> listOfUsersIds = List.of(mentorshipRequestDto.getRequesterId(), mentorshipRequestDto.getReceiverId());
        List<User> listOfUsers = List.of(userWithId3, userWithId5);
    ...
    public void testRequestMentorshipCallsValidateUsersExistenceWithReceiverId5AndRequesterId4() {
        ...
        var mentorshipRequestDto = mrDtoWithId1;

        setUp(mentorshipRequestDto);
