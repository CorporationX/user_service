...
public class SubscriptionServiceTest {
    ...
    public void testUnfollowedSuccess() {
        ...
        Mockito.verify(subscriptionRepo, Mockito.times(50))
    ...
    public void testFollowedSuccess() {
        ...
        Mockito.verify(subscriptionRepo, Mockito.times(100))
    ...
    public void testFollowingCount() {
        ...
        Assertions.assertEquals(0, subscriptionService.getFollowingCount(1L));
    }

    @Test
    public void testFollowersCount() {
        Mockito.when(subscriptionRepo.findFollowersAmountByFolloweeId(1L)).thenReturn(5);
        Assertions.assertEquals(12, subscriptionService.getFollowersCount(1L));
